		...
		<div class="header-body">
			<div class="row align-items-center py-4">
				<div class="col-lg-6 col-7">
					<h6 class="h2 d-inline-block mb-0"><?php echo "$title - $member->nama"; ?></h6>
				</div>
				<div class="col-lg-6 col-5 text-right">
					<a href="<?php echo base_url('admin/member/all')?>" class="btn btn-danger btn-sm btn-icon"><i class="fa fa-reply"></i> Kembali</a>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="card card-profile">
				...
				<div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
					<div class="d-flex justify-content-between">
						<a href="<?php echo "https://api.whatsapp.com/send/?phone=62$member->no_hp"; ?>" class="btn btn-sm btn-success mr-4">Whatsapp</a>
						<a href="<?php echo "mailto:$member->email"; ?>" class="btn btn-sm btn-default float-right">Email</a>
					</div>
				</div>
