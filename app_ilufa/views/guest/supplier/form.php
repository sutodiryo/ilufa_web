                                    ...
                                    <div class="form-row mb-4">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="placeholder js-states form-control" name="id_location_village " id="id_location_village" required>
                                                <option disabled selected>Desa/Kelurahan...</option>
                                                <?php
                                                foreach ($district as $di) {
                                                    echo "<option value='$di->id_location_district'>";
                                ...
                                <div class="col-md-12">
                                    <div class="statbox widget box box-shadow">
                                        <div class="widget-content widget-content-area">
                                            ...
                                            <div class="input-group mb-4">
                                                <input type="hidden" name="id_jobs" value="<?php echo $detail_job->id_job ?>">
                                            ...
                                            <div class="form-row mb-4">
                                                ...
                                                <div class="form-group col-md-12 text-right">
                                                    <button disabled class="btn btn-outline-dark btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-plus">
