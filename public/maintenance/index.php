...
<head>
	...
	<title>168 Ilufa - Under Construction</title>
	...
	<script type="text/javascript" src="js/jackhammer.js"></script>
	<script type="text/javascript" src="js/jackhammer-countdown.js"></script>
	<link rel="stylesheet" type="text/css" href="css/jackhammer.css">
	<link rel="stylesheet" type="text/css" href="css/jackhammer-character.css">
...
<body>
	...
	<div class="jackhammer">
		...
		<div class="svg_holder">
			...
			<svg id="jackhammerSVG" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 196.3 276.8" enable-background="new 0 0 196.3 276.8" xml:space="preserve" preserveAspectRatio="xMidYMax">
				<g id="jackhammerMan">
					<g id="jackBody">
		...
		<div id="jackhammer_title">Our Website is Under Construction.</div>
		<div id="jackhammer_countdown">


			<svg version="1.1" id="svg_countdown" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="406px" height="114px" viewBox="0 0 406 114" enable-background="new 0 0 406 114" xml:space="preserve">
				<g>
					<polygon class="shadowColor" id="countdownshadow" points="406,114 406,14 400,8 0,108 6,114 406,114 	" />
					<g class="jackhammer_cube" id="jackhammer_cube1">
						<rect class="boxSide" x="0" y="20" width="100" height="100" />
						<rect class="boxTop" x="0" y="12" width="100" height="100" />
						<text id="daysLeft" class="jhcount" text-anchor="middle" transform="matrix(1 0 0 1 50 77)">0</text>
						<text transform="matrix(1 0 0 1 50 96)" class="jhtime">days</text>
					</g>
					<g class="jackhammer_cube" id="jackhammer_cube2">
						<rect x="100" y="20" class="boxSide" width="100" height="100" />
						<rect x="100" y="12" class="boxTop" width="100" height="100" />
						<text id="hoursLeft" class="jhcount" text-anchor="middle" transform="matrix(1 0 0 1 150 77)">0</text>
						<text transform="matrix(1 0 0 1 150 96)" class="jhtime">hours</text>
					</g>
					<g class="jackhammer_cube" id="jackhammer_cube3">
						<rect x="200" y="20" class="boxSide" width="100" height="100" />
						<rect x="200" y="12" class="boxTop" width="100" height="100" />
						<text id="minutesLeft" class="jhcount" text-anchor="middle" transform="matrix(1 0 0 1 250 77)">0</text>
						<text transform="matrix(1 0 0 1 250 96)" class="jhtime">minutes</text>
					</g>
					<g class="jackhammer_cube" id="jackhammer_cube4">
						<rect x="300" y="20" class="boxSide" width="100" height="100" />
						<rect x="300" y="12" class="boxTop" width="100" height="100" />
						<text id="secondsLeft" class="jhcount" text-anchor="middle" transform="matrix(1 0 0 1 350 77)">0</text>
						<text transform="matrix(1 0 0 1 350 96)" class="jhtime">seconds</text>
					</g>
				</g>
			</svg>
		...
		<div class="jackhammer_clear"></div>
		<div id="jackhammer_socialmedia">

			<ul>
				<!-- <li><a href="#"><img src="images/twitter.svg"></a></li> -->
				<li><a href="https://instagram.com/168ilufa_official"><img src="images/ig.svg"></a></li>
				<li><a href="https://facebook.com/ilufaofficial"><img src="images/facebook.svg"></a></li>
				<li><a href="https://www.youtube.com/channel/UCOns8B-ZYPeeGDD8AVR4kAA"><img src="images/youtube.svg"></a></li>
				<li><a href="mailto:168@ilufa.co.id"><img src="images/mail.svg"></a></li>
				<!-- <li><a href="#"><img src="images/dribbble.svg"></a></li> -->
			</ul>
