$(document).ready(function() {
    ...
    $('#advance-8').DataTable({
        "language": {
            "url": "http://localhost/ilufa/web/public/back/json/German.json"
        }
    });
    $('#advance-9').DataTable({
        "searching": false,
    ...
    $('#data-source-2').DataTable({
        "ajax": 'http://localhost/ilufa/web/public/back/ajax/arrays.txt'
    });
    var dataSet = [
    ...
    $('#data-source-4').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "http://localhost/ilufa/web/public/back/json/server-side.json"
    } );
    ...
    var ct = $('#API-chield-row').DataTable({
        "ajax": "http://localhost/ilufa/web/public/back/ajax/api.txt",
        "columns": [{
    ...
    $('#ajax-data-object').DataTable({
        "ajax": "http://localhost/ilufa/web/public/back/ajax/object.txt",
        "columns": [{
            "data": "name"
        }, {
            "data": "position"
    ...
    $('#ajax-data-nested-object').DataTable({
        "processing": true,
        "ajax": "http://localhost/ilufa/web/public/back/ajax/object_nested.txt",
        "columns": [{
            "data": "name"
            }, {
                "data": "hr.position"
    ...
    $('#orthogonal-data').DataTable({
        ajax: "http://localhost/ilufa/web/public/back/ajax/orthogonal.txt",
        columns: [{
            data: "name"
        }, {
            data: "position"
    ...
    $('#server-side-datatable').DataTable( {
        "processing": true,
        "serverSide": true,
        "ajax": "http://localhost/ilufa/web/public/back/ajax/server-processing.php"
    });
    ...
    $('#datatable-http').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "http://localhost/ilufa/web/public/back/ajax/server-processing.php",
            data: function(d) {
                d.myKey = "myValue";
            }
        },  
    ...
    $('#datatable-post').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: "http://localhost/ilufa/web/public/back/ajax/post.php",
            type: "post"
        },
        "columns": [{
            "data": "first_name"
