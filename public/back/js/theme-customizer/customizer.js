...
$(document).ready(function () {
     ...
     $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", "http://localhost/ilufa/web/public/back/css/"+color+".css" );
    ...
    $('.sidebar-type li').on('click', function () {
        ...
        switch (type) {
            ...
            case 'normal-sidebar': {
                ...
                $(".logo-wrapper").find('img').attr('src', 'http://localhost/ilufa/web/public/back/images/logo/logo.png');
